...
class SMTP
{
     ...
     */
<<<<<<< HEAD:include/vendor/phpmailer/src/SMTP.php
    const VERSION = '6.10.0';
||||||| 7dd05ee12:include/vendor/phpmailer/src/SMTP.php
    const VERSION = '6.1.8';
=======
    const VERSION = '7.0.2';
>>>>>>> origin/fix/jquery-deprecations:include/vendor/phpmailer/phpmailer/src/SMTP.php

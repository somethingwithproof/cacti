...
<<<<<<< HEAD:include/vendor/phpmailer/get_oauth_token.php
    echo 'Refresh Token: ', htmlspecialchars($token->getRefreshToken());
||||||| 7dd05ee12:include/vendor/phpmailer/get_oauth_token.php
    // Use this to interact with an API on the users behalf
    // Use this to get a new access token if the old one expires
    echo 'Refresh Token: ', $token->getRefreshToken();
=======
    echo 'Refresh Token: ', htmlspecialchars($token->getRefreshToken(), ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401);
>>>>>>> origin/fix/jquery-deprecations:include/vendor/phpmailer/phpmailer/get_oauth_token.php
}

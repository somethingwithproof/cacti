...
if ($config['is_web']) {
	...
	header("Content-Security-Policy: default-src *; img-src 'self' https://api.qrserver.com $alternates data: blob:; style-src 'self' 'unsafe-inline' $alternates; $script_src; frame-ancestors 'self'; worker-src 'self' $alternates;$report_uri");

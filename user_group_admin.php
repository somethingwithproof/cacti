...
function user_group() : void {
	...
	// (GHSA-84q3-92xc-c3pf)
	$sort_allowed   = ['name', 'members', 'description', 'policy_graphs', 'policy_hosts', 'policy_graph_templates', 'enabled'];
	$sort_column    = cacti_validate_sort_column((string) grv('sort_column'), $sort_allowed, 'name');

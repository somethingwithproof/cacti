...
function html_common_header(string $title, string $selectedTheme = '') : void {
	...
	<script type='text/javascript'>
		...
		var defaultSNMPAuthProtocol = <?php print json_encode((string) read_config_option('snmp_auth_protocol')); ?>;
		var defaultSNMPPrivProtocol = <?php print json_encode((string) read_config_option('snmp_priv_protocol')); ?>;
		var defaultSNMPSecurityLevel = <?php print json_encode((string) read_config_option('snmp_security_level')); ?>;
		...
		var theme = <?php print json_encode((string) $selectedTheme); ?>;

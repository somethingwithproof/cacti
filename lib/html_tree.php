					...
					if (isset($snmp_index_to_graph[$snmp_index])) {
						foreach ($snmp_index_to_graph[$snmp_index] as $local_graph_id => $graph_title) {
							...
							array_push($graph_list, [
								...
								'height'           => $graphs_height[$local_graph_id] ?? read_config_option_int('default_graph_height'),
								'width'            => $graphs_width[$local_graph_id] ?? read_config_option_int('default_graph_width')
							]);
						}
					}
				}
